...
<cfelseif isdefined('form.action') and form.action eq 'createaccount'>
	...
	<cfset sendEmail(form.email,emailbody,"Please confirm your account with #cgi.http_host#")>	
...
<cfelseif isdefined('form.action') and form.action eq 'sendFavsToFriend'>
	   ...
	   <cfoutput>
		...
		<table>
			...
			<cfloop query="getFavs">
				...
				<tr>
					<td align="left" valign="top"><img src="#property.defaultPhoto#" align="left" width="200" height="150" border="0" style="padding-right:10px"></td>
					<td valign="top">
	...
	<cfset sendEmail(form.friendsemail,emailbody,"Check out these properties I found on #cgi.http_host#",form.youremail)>
...
<cfelseif isdefined('form.action') and form.action eq 'forgotPassword'>
	...
	<cfif getUser.recordcount gt 0>
	   ...
	   <cfsavecontent variable="emailbody">
		...
		<cfset sendEmail(form.email,emailbody,"Password Reset from #cgi.http_host#")>
