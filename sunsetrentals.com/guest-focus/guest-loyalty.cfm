...
<!--- Get the number of points this guest has already redeemed --->
...
<div class="content-wrap">
  ...
  <div class="guest-loyalty">
	 ...
	 <!--- Loop through redeemed points --->
	 <cfset totalPointsRedeemed = 0>
	 <cfloop query="getRedeemedPoints">
	 	<cfset totalPointsRedeemed = totalPointsRedeemed + pointsRedeemed>
	 </cfloop>
	 
	 <cfset totalPointsEarnedTop = totalPointsEarnedTop - totalPointsRedeemed>
      ...
      <div class="panel-body">
        <table class="table table-condensed table-hover">
          <tr>
            ...
            <th class="row-7"></th>
            <th class="row-8 text-center"># Points</th>
            <th class="row-2 text-center">You need</th>
          </tr>
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="controls">
                      <select name="reason" class="form-control" class="required">
                        <option value=" ">- Choose One -</option>
                        <cfloop query="getPointLevels">                        	
                        	<cfoutput><option>#title#</option></cfoutput>
                        </cfloop>
                        <option>Other</option>
                      </select>
                    </div>
