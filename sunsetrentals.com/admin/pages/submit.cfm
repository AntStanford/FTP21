...
<cfelse>  <!---insert statement--->
  ...
  <cfquery dataSource="#application.dsn#" result="theinsert">
    insert into cms_pages(name,body,slug,h1,metatitle,metadescription,showinnavigation,parentID,externalLink,triggerOnly,ignoreParentSlug,bodyClass,layout,popularSearch,popularSearchPhoto,showInFooter,customSearchJSON,isCustomSearchPage,canonicalLink<cfif form.parentID neq 0>,subsort</cfif>)
    values(
