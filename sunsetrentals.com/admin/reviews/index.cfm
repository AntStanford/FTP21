  ...
  <div class="widget-content nopadding">
    ...
    <cfoutput query="getinfo">
       <cfquery name="getProperties" dataSource="#settings.booking.dsn#">
        select id,shortName from track_properties where id = <cfqueryparam CFSQLType="cf_sql_varchar" value="#getinfo.unitcode#">
      </cfquery>
      <tr>
        <td width="45">#currentrow#.</td>
        <td>#firstname# #lastname#</td> 
        <td width="80">#unitcode# - #getProperties.shortName#</td>           
        <td width="75">
          <cfif approved eq 'No'>
