<div id="reviews" name="reviews" class="info-wrap reviews-wrap">
  ...
  <div class="info-wrap-body">
    ...
    <cfif numReviews gt 0>
  	  <div class="owl-carousel reviews-carousel">
  	    ...
  	    <blockquote class="review">
  	      ...
  	      <div class="signature">- <cfif len(reviews[index].firstname)>#reviews[index].firstname#<cfelse>Anonymous</cfif> #Left(reviews[index].lastname,1)# <cfif len(reviews[index].hometown)>from #reviews[index].hometown#</cfif>, Posted: #DateFormat(reviews[index].reviewDate,'mm/dd/yyyy')#</div>
    ...
    <div class="btn-group">
      <cfif numReviews gt 0><button id="nextReview" class="btn site-color-1-bg site-color-3-bg-hover text-white" type="button">Next Review</button></cfif>
      <button id="writeReview" class="btn site-color-2-bg site-color-3-bg-hover text-white" type="button" data-toggle="modal" data-target="#writeReviewModal">Write Review</button>
    </div>
