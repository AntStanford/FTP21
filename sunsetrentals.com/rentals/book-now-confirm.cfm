...
<!--- Authority: http://pt.icnd.net/projects/view-task.cfm?projectID=855&taskID=55778 --->
  ...
  <div class="row clearfix">
    <div class="col-md-12">
      <cfoutput>
				...
				<p>A confirmation email will be sent to #form.email# for your records.</p>
			</cfoutput>
    </div>
					...
					<div>
						<cfoutput>																	
							<cfif isdefined('form.travelInsurance') and form.travelInsurance is "true">
								<p>Total Amount for Reservation: #DollarFormat(form.TotalTotalWithInsurance)#</p>
								<p>You purchased travel insurance for #DollarFormat(form.tripinsuranceamount)#</p>
							<cfelse>
								<p>Total Amount for Reservation: #DollarFormat(form.TotalTotal)#</p>
							</cfif>
						</cfoutput>
					</div>
				</div>
