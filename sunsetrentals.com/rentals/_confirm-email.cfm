...
<cfoutput>
   	...
   	<table cellpadding="0" cellspacing="0">   			
         ...
         <cfif isdefined('form.travelInsurance') and form.travelInsurance is "true">
         	<tr><th align="left">Total Amount for Reservation</th><td>#Dollarformat(form.TotalTotalWithInsurance)#</td></tr>
         	<tr><th align="left">You purchased travel insurance for</th><td>#Dollarformat(form.tripinsuranceamount)#</td></tr>
         <cfelse>
         	<tr><th align="left">Total Amount for Reservation</th><td>#Dollarformat(form.TotalTotal)#</td></tr>
         </cfif>
