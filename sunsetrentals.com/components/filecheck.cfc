<cfcomponent displayname="fileCheck">
  ...
  <cffunction name="Check">
    ...
    <cfif cffile.filesize gt "204800">
      <cfset variables.e = variables.e & "<li>File must be less than 200kb in size.">
    </cfif>

    <cfif variables.e is "">
      <cfif listFindNoCase("jpg,gif,png,pdf,doc,docx,",cffile.serverfileext) is false>
    ...
    <cfif variables.e is "">
        ...
        <cftry>
            <cfset sourceFileWithPath = "#variables.temp_photos_path#/#source_file#">
  ...
  <cffunction name="PDFCheck">
    ...
    <cfif variables.e is "">
      <cfif listFindNoCase("pdf",cffile.serverfileext) is false>
        <cfset variables.e = variables.e & "<li>Invalid File Type">
      </cfif>
    </cfif>
