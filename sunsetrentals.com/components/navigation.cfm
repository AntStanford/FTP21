      ...
      <li>
        ...
        <cfelse>
          <cfif len(getTopLevelNav.externalLink)>
            <a href="#getTopLevelNav.externalLink#" target="_blank" class="site-color-3 site-color-1-hover" rel="noopener">#name#</a><i class="fa fa-chevron-down text-white"></i>
          <cfelse>
        ...
        <ul>
          <cfloop query="getSubNav">
            <cfif len(getSubNav.externalLink)>
              <li><a href="#getSubNav.externalLink#" target="_blank" class="site-color-3 text-white-hover" rel="noopener">#name#</a></li>
            <cfelse>
              <li><a href="/#getSubNav.slug#" class="site-color-3 text-white-hover">#name#</a></li>
            </cfif>
          </cfloop>
        </ul>
      </li>
