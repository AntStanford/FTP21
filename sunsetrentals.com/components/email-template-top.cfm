...
<body>
  <!-- Start of header -->
  <table width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header" style="padding-top:8px;border-bottom:3px solid #2e3337;">
    <tbody>
      <tr>
        <td>
              ...
              <tr>
                <td width="100%" style="padding:0 5px 0 5px">
                  <a target="_blank" href="http://<cfoutput>#settings.website#</cfoutput>">
                    <img src="http://<cfoutput>#settings.website#</cfoutput>/images/layout/sunset-rentals-email-logo.jpg"  alt="" border="0" style="display:block;border:none;outline:none;text-decoration:none;margin:0 auto;padding:12px 0;max-width:100%;">
                  </a>
                </td>
              </tr>
            </tbody>
