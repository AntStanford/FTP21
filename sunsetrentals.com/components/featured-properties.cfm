...
<cfif getFeaturedProperties.recordcount gt 0>
  <div class="i-featured">
  	<div class="container">
  	  <p class="h2 text-center"><span>view our</span><br> Featured Properties</p><br>
          ...
          <div class="featured-property">
            <div class="featured-property-img-wrap">
              <a href="/#settings.booking.dir#/#seopropertyname#" class="featured-property-link" target="_blank">
                ...
                <cfif len(photo)>
                  <span class="featured-property-img owl-lazy" data-src="https://img.trackhs.com/355x231/#replace(photo,' ','%20','all')#"></span>
                <cfelse>
                  <span class="featured-property-img owl-lazy" data-src="https://placeholdit.imgix.net/~text?txtsize=14&txt=placeholder&w=200&h=150"></span>
                </cfif>
              </a>
