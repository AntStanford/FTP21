<cfif len(settings.address) and len(settings.city) and len(settings.state) and len(settings.zip)>
  ...
  <div class="embed-responsive embed-responsive-16by9">
	<cfoutput><iframe src="https://maps.google.com/maps?q=#settings.address#%2C+#settings.city#%2C+#settings.state#+#settings.zip#&ie=UTF8&output=embed" width="600" height="450" frameborder="0" style="border:1px solid ##e3e3e3" allowfullscreen></iframe></cfoutput>
  </div><br>
</cfif>
<!---
<div class="row">
...
<!--- TEMPORARILY REMOVE CONTACT FORMS Task 68103 - MC  --->
