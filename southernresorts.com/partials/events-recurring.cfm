  ...
  <div class="month-tabs">
    ...
    <ul class="nav nav-pills">
      <cfloop from="0" to="#showMonths#" index="i">
        <cfset future_date = DateAdd("m", i, now())>
        <li role="presentation"><a href="javascript:;" id="tab_#i#" data-month="#dateformat(future_date, 'mm')#" data-year="#dateformat(future_date, 'yyyy')#">#dateformat(future_date, 'mmmm')#</a></li>
      </cfloop>
    </ul>
  </div>
