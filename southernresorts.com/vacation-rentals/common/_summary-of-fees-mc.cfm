...
<cfif ListFind('70.40.100.144,99.1.177.220', CGI.REMOTE_ADDR)>
	<cfdump var="#local.apiformFields#">
	...
	<cfif StructKeyExists(json,'breakdown') and StructKeyExists(local.booknowjson.breakdown,'charges') and StructKeyExists(local.booknowjson.breakdown.charges,'itemized')>
				        ...
				        <div class="alert-success">
				            <h4 class="panel-title">
				                <a data-toggle="collapse" href="##collapse1">
				                  <div class="property-cost-list-total"> <span id="costRowShowHide" class="glyphicon glyphicon-plus"></span> <strong>Total</strong> <span class="text-right">#DollarFormat(local.booknowjson.breakdown.total)#</span></div>
				                </a>
				            </h4>
				        </div>
				--->
		...
		<table class="table table-striped">
			...
			<tr>
				...
				<td align="right">#DollarFormat(local.booknowjson.breakdown.rent)#</td>
			</tr>
			...
			<cfif StructKeyExists(json,'promoCode')>
				<tr id="promoCodeTr">
					<td>Discount</td>
					<td align="right">(#DollarFormat(local.booknowjson.breakdown.discount)#)</td>
				</tr>
				<!---<tr><td colspan="2">Promo code applied!</td></tr>--->
			</cfif>
<!--- 		</table> --->
...
--->
			...
			<tr class="success amount-with-insurance" style="display: none;">
				...
				<td align="right">#DollarFormat(local.booknowjson.breakdown.travelInsurance)#</td>
			</tr>
<!---
			<tr>
...
<!--- 		<table class="table table-striped"> --->
	...
	--->		
			...
			<cfif val( numdaysout ) gte variables.defaultDaysOut>
				<!--- <cfset halftotal += local.booknowjson.breakdown.total / 2 /> --->
...
<!---
				<tr class="success amount-without-insurance">
					...
					<td align="right">#dollarFormat( local.booknowjson.breakdown.total )#</td>
				</tr>
...
<cfelse>
	<div class="alert alert-info">
					<p>
						<label for="fulltotal">Due Today <span id="summarytotalr2">#dollarFormat( local.booknowjson.breakdown.total )#</span></label></p>
