...
<cfset returnJson = '{"COLUMNS": ["ISPROPERTY","SEOPROPERTYNAME","SEODESTINATIONNAME", "UNITCODE", "MAPPHOTO", "UNITSHORTNAME", "BEDROOMS", "BATHROOMS", "MAXOCCUPANCY", "LATITUDE", "LONGITUDE", "MAPPRICE", "ISARRAY", "PROPARRAY"], "DATA": [' />
