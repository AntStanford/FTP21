...
<cfif CGI.REMOTE_ADDR eq "173.93.73.19">
	jjj
	<cfoutput><cfdump var="#nonAvailListForDatepicker#"></cfoutput>
	<cfelse>
	</cfif>
  				...
  				<table class="table table-bordered calendar-table">
    				<tr><th class="month" colspan="7"><cfoutput><strong>#DateFormat(ThisMonthYear,"MMMM YYYY")#</strong></cfoutput></th></tr>
  					...
  					<tr>
  						...
  						<td class="text-gray<cfoutput><cfif formattedDate lt #dateformat(now(),'yyyy-mm-dd')#> booked<cfelse> #myclass#</cfif></cfoutput>" width="14.28%">
