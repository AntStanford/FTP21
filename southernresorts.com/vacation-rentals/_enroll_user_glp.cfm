...
<cfif userCheck.recordcount gt 0>
	...
	<cfset sendEmail(form.email,welcomeglp,"Guest Loyalty Program - Follow Up","","","patriciah@gosouthern.com")>
...
<cfelse>
	...
	<cftry>
		...
		<cfset sendEmail(form.email,welcomeglp,"Welcome to the #settings.company# Guest Loyalty Program!","","","patriciah@gosouthern.com")>
