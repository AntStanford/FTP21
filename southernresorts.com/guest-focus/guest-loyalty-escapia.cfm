...
<cfquery name="getBookings" dataSource="#settings.dsn#">
	select 
		reservationNumber as resNumber,
		escapiaNETUnitCode as propertyid,
		arrivalDate as strcheckin,
		departureDate as strcheckout 
        ...
        <table class="table table-condensed table-hover">
          ...
          <cfloop query="getBookings">          
			  ...
			  <cfquery name="getPropertyInfo" dataSource="#settings.dsn#">
			  		...
			  		where unitcode = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#getBookings.propertyid#">
			  </cfquery>
