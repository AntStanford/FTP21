<!--- <cfif cgi.remote_host eq '75.87.66.209'>
  <cfif isDefined('url.__trackcampaign')>
    <cfset session.__trackcampaign = url.__trackcampaign />
  </cfif>
</cfif> --->
...
<cfelse>
  ...
  <cfif temp contains 'utm_source' or temp contains 'fbclid' or temp contains 'fbclid' or temp contains 'gclid' or temp contains 'phonalytics' or temp contains 'nck' or temp contains '__trackcampaign'>
    <cfset slug = 'index'>
