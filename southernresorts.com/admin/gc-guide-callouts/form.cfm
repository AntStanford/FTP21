<cfset page.title ="Gulf Coast Guide CallOuts">
<cfset module = 'callout'>
<cfinclude template="/admin/components/header.cfm">  
  
<cfif isdefined('url.id')>
  <cfquery name="getinfo" dataSource="#application.dsn#">
    select * from cms_gulfcoast_guide_callouts where id = #url.id#
  </cfquery>
</cfif>
  ...
  <div class="widget-box">
    ...
    <div class="widget-content nopadding">
      ...
      <div class="control-group">
          ...
          <div class="controls">
            <input type="text" name="heading2" <cfif parameterexists(id)>value="#getinfo.heading2#"</cfif>>
          </div>
        </div>
		  <div class="control-group">
        ...
        <div class="control-group">
            ...
            <cfif parameterexists(id) and len(getinfo.photo)>
              <br /><img src="/images/gc-guide-callouts/#getinfo.photo#">
            </cfif>              
			    </div>
				</div>
