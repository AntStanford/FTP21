<cftry> 
     <cfcache action="flush" key="cms_gc_guide_callouts">
     <cfcatch></cfcatch> 
</cftry>


<!--- On page variables --->
<cfset uppicture = #ExpandPath('/images/gc-guide-callouts')#>
<cfset table = 'cms_gulfcoast_guide_callouts'>
...
<cfelseif isdefined('form.id')>
    ...
    <cfquery dataSource="#application.dsn#">
      ...
      heading2 = <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#form.heading2#">,
...
<cfelse>
    ...
    <cfquery dataSource="#application.dsn#">
      insert into #table#(title,heading2,link,photo,sort) 
      values(
        <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#form.title#">,
        <cfqueryparam CFSQLType="CF_SQL_VARCHAR" value="#form.heading2#">,
