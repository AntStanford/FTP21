<cfif isdefined('url.id')>
  <cfquery name="getinfo" dataSource="#application.dsn#">
    select * from cms_alerts where id = #url.id#
  </cfquery>
</cfif>

<cfset page.title ="Home Page Alert">
<cfset module = 'alert'>
    ...
    <div class="widget-content nopadding">
      ...
      <form action="submit.cfm" method="post" class="form-horizontal">
        <div class="control-group">
					...
					<div class="controls">
						<input maxlength="255" name="heading" type="text" <cfif parameterexists(id)>value="#getinfo.heading#"</cfif>>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input maxlength="255" name="subheading" type="text" <cfif parameterexists(id)>value="#getinfo.subheading#"</cfif>> 
					</div>
				</div>
