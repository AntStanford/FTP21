<cfset page.title ="Long Term Rental Photo Gallery">
<cfset uppicture = '/images/longtermrentals'>
<cfset module = 'photo'>

<cfquery name="getphotos" dataSource="#dsn#">
  select id,thefile from cms_assets where foreignKey = <cfqueryparam CFSQLType="CF_SQL_varchar" value="#url.id#">
...
<cfoutput>
  ...
  <div class="widget-box">
    ...
    <div class="widget-content">
      ...
      <form id="fileupload" action="submit-multi.cfm?galleryName=#url.id#" method="POST" enctype="multipart/form-data">
</cfoutput>
        ...
        <div class="container" style="width:95%">
            ...
            <div class="col-lg-7">
              <div class="upload-buttons">
                ...
                <cfoutput><a href="formmulti.cfm?id=#url.id#" class="btn btn-info">Refresh Page</a></cfoutput>
...
{% } %}
      ...
      <cfoutput>
<cfif parameterexists(id) and getphotos.recordcount gt 0>
      ...
      <a href="sort-list.cfm?id=#url.id#" class="btn btn-info">Click here to edit the sort order</a><br /><br />
		<ul id="sort-list" class="thumbnails">
  		  <cfloop query="getphotos">
    		   ...
    		   <br /><a href="delete.cfm?resortID=#url.id#&photo=#thefile#&photoid=#getphotos.id#" class="btn btn-danger"><i class="icon-remove icon-white"></i> Delete</a>
    		  </li>
    		</cfloop>
  		</ul>
...
<cfloop query="getphotos">
  <style type="text/css" scoped>
    /*.modal.fade { position: absolute; margin-top: 20px; margin-left: -415px; left: 50% !important; }

    .modal-body { width:95% !important;overflow:display;text-align:center; }*/
  </style>
  <div id="modal#id#" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modallbl#id#" aria-hidden="false">
    ...
    <div class="modal-body">
      <img src="/images/longtermrentals/#thefile#" style="height:350px;">
    </div>
