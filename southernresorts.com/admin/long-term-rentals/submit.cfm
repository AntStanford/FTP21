...
<cfelse>
    ...
    <cfquery dataSource="#application.dsn#">
      insert into #table#(name,slug,address,type,bedrooms,bathrooms,monthly_rate,pet_friendly,available_now,description,amenities,mainphoto,metaTitle,metaDescription,city,state,zip,status) 
      values(
