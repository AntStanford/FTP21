...
<p><a href="form.cfm" class="btn btn-success"><i class="icon-plus icon-white"></i> Add New</a>
&nbsp;&nbsp;
<a href="import1.cfm" class="btn btn-success"><i class="icon-plus icon-white"></i> Import Pages</a>	
</p>
