  ...
  <div class="widget-box">
    ...
    <div class="widget-content nopadding">
      ...
      <cfif parameterexists(id) and len(getinfo.slug)>
         <a href="/#getinfo.slug#" target="_blank" class="btn btn-default pull-right" style="margin-right:15px"><i class="icon-eye-open"></i> View</a>
         <a target="_blank" href="contentbuilder/edit-page.cfm?id=#id#" class="btn pull-right btn-info" style="margin-right:5px;"><i class="icon-pencil icon-white"></i> Content</a>
      </cfif>
      ...
      <form action="submit.cfm" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="tab-pane active" id="basicTab">
            ...
            <cfelse>
  				  	  ...
  				  	  <cfset layoutList = 'Default.cfm,Full.cfm,Left-sidebar.cfm,gulf-coast-landing.cfm,thingstodo-categories.cfm'>
...
--->
            ...
            <div class="control-group">
	            ...
	            <div class="controls">
	              <div class="uploader" id="uniform-undefined" style="width:290px;">
	                <input type="file" size="19" name="headerimage" id="fileName" style="opacity:0;">
	              ...
	              <cfif isdefined('url.id') and getinfo.headerimage neq ''>
	                <br><br>Preview:
                  <div id="chosenBanner">
	                  <img src="/images/header/#getinfo.headerimage#" style="width:50%">
                  </div>
	              ...
	              <cfelse>
	                <br><br>Default Image:
	                <br><img src="/images/layout/hero-int.jpg" style="width:50%">
                </cfif>
            ...
            <div class="control-group">
              <label class="control-label">Video Link URL</label>
              <div class="controls">
                <input maxlength="255" name="videoLinkURL" <cfif parameterexists(id)>value="#getinfo.videoLinkURL#"</cfif> type="text">
                <div class="note">The Video link from YouTube should look like something like this: 'https://www.youtube.com/embed/brqObHQ7k7U'. To find this type of link, go to the YouTube page for the video you are going to use, click 'Share', then 'Embed'. A screen will then popup that you can copy the URL from. <a href="/admin/images/Southern-Resorts-Video-Link.png" target="_blank">Click here to see a screenshot example.</a>
              </div>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <cfif isdefined('url.id') and getinfo.headerimage neq ''>
          <img src="/images/header/<cfoutput>#getinfo.headerimage#</cfoutput>" style="width:100%">
        </cfif>
