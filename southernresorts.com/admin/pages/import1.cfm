<cfset page.title ="Page Import">
<cfinclude template="/admin/components/header.cfm">
<cfset variables.errors = arrayNew(1)>
<cfset variables.importStep = 1>
...
<cfif StructKeyExists(form,'excelFile')>
    ...
    <cfif right(upload.serverFile,5) EQ ".xlsx">
      <cftry>
        <cfspreadsheet action="read" src="#variables.xlsFile#" query="Session.qryExcel" headerrow="1" excludeHeaderRow="true" sheetname="#form.worksheet#">
      	<cfcatch type="any">
    			<cfset variables.errors[arraylen(variables.errors)+1] = "The worksheet name entered was not found in the Excel file.">
        </cfcatch>
      </cftry>
    <cfelse>
		...
		<cfif exists.recordcount>
			<cfquery name="updatePage" dataSource="#dsn#">
				...
				name = <cfif len(trim(Session.qryExcel[form.pageH1][Session.qryExcel.CurrentRow])) GT 0>
					  <cfqueryparam value="#Session.qryExcel[form.pageH1][Session.qryExcel.CurrentRow]#" cfsqltype="cf_sql_varchar">
					<cfelse>
					  <cfqueryparam value="#Session.qryExcel[form.pageTitle][Session.qryExcel.CurrentRow]#" cfsqltype="cf_sql_varchar">
						  </cfif>,
				h1 = <cfqueryparam value="#Session.qryExcel[form.pageH1][Session.qryExcel.CurrentRow]#" cfsqltype="cf_sql_varchar">,
				metatitle = <cfqueryparam value="#Session.qryExcel[form.pageTitle][Session.qryExcel.CurrentRow]#" cfsqltype="cf_sql_varchar">,
      ...
      <div class="table-wrap">
        <form action="import1.cfm" method="post" enctype="multipart/form-data" class="form-horizontal" >
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input class="sluggable" style="width:300px" maxlength="255" name="worksheet" type="text" value="Normal Pages)">
            </div>
          </div>
