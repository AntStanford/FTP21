...
<cfquery name="getphotos" dataSource="#dsn#">
  select id,thefile from cms_assets where section = <cfqueryparam value="Gallery" cfsqltype="cf_sql_varchar"> and galleryID = <cfqueryparam value="#url.id#" cfsqltype="cf_sql_integer"> order by sort
</cfquery>
...
<cfoutput>
  ...
  <p>
    <a href="/admin/galleries/index.cfm" class="btn btn-primary"><i class="icon-list icon-white"></i> Back to Gallery List</a>
    <a href="/admin/galleries/form.cfm?id=#url.id#" class="btn btn-success"><i class="icon-pencil icon-white"></i> Edit Gallery</a> 
  </p>
  ...
  <div class="widget-box">
    ...
    <div class="widget-content">
      ...
      <form id="fileupload" action="/admin/galleries/multi-upload-gallery/submit-multi.cfm" method="POST" enctype="multipart/form-data">
       <input type="hidden" name="galleryid" value="#url.id#">
</cfoutput>
